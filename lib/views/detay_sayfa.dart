        ...
        child: Padding(
          ...
          child: SizedBox(
            child: Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                Text("${widget.yemek.yemek_adi}", style: TextStyle(fontSize: 25, fontWeight: FontWeight.w500, color: Colors.black54),),
                SizedBox(
                  child: SizedBox(
                    width: 180.0,
                    height: 180.0,
          ...
          onPressed: (){
            if(sayac == 0){
              ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                content: Text("İşlem başarısız", textAlign: TextAlign.center),
                backgroundColor: color6,),);
            }else{
              setState(() {
                var kullanici_adi = "haygenli";
