  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        titleTextStyle: const TextStyle(fontSize: 25.0, fontWeight: FontWeight.w500),
        centerTitle: true,
        leading: IconButton(
            onPressed: (){
                                  ...
                                  child: Column(
                                    children: [
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            Text(sepet.yemek_adi, style: TextStyle(fontWeight: FontWeight.w500, fontSize: 20, color: anaRenk),
                                            ),
                                          ],
                                        ),
                                      ),
                  ...
                  child: BlocBuilder<SepetSayfaIslemCubit, int>(
                      builder: (context, fiyat){
                        if (fiyat == 0){
                          ...
                          return Text("$fiyat ₺", style: const TextStyle(fontSize: 22.0, fontWeight: FontWeight.w500, color: Colors.white),);
                        }
                      }),
                ),
              ),
